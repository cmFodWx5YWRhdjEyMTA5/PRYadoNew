...
public class PhotoPreview {
  ...
  public static class PhotoPreviewBuilder {
    ...
    public PhotoPreviewBuilder setFrom(String from) {
      mPreviewOptionsBundle.putString(EXTRA_FROM, from);
      return this;
    }

    public PhotoPreviewBuilder setPosition(int position) {
      mPreviewOptionsBundle.putInt(EXTRA_POSITION, position);
      return this;
    }
  }
}
