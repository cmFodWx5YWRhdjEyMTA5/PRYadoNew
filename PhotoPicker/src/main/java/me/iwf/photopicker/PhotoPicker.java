...
public class PhotoPicker {
    ...
    public static class PhotoPickerBuilder {
        ...
        public PhotoPickerBuilder setFrom(String s) {
            mPickerOptionsBundle.putString(EXTRA_FROM, s);
            return this;
        }
        public PhotoPickerBuilder setPosition(int position) {
            mPickerOptionsBundle.putInt(EXTRA_POSITION, position);
            return this;
        }
    }
}
